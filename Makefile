...
SERVER_SOURCES = $(SERVER_DIR)/db.ml $(SERVER_DB_REQUESTS_DIR)/player_requests.ml $(SERVER_DB_REQUESTS_DIR)/game_requests.ml $(SERVER_DIR)/external_messages.ml $(SERVER_DIR)/rating.ml $(SERVER_DIR)/server.ml $(SERVER_DIR)/main.ml
